...
public abstract interface ownerService {
    ...
    @org.jetbrains.annotations.Nullable()
    @retrofit2.http.DELETE(value = "queue/{queId}/delete/{userId}")
    ...
    @org.jetbrains.annotations.Nullable()
    @retrofit2.http.GET(value = "queue/{queId}/count")
    ...
    @org.jetbrains.annotations.Nullable()
    @retrofit2.http.GET(value = "queue/{queId}/getNames")
